...
public class GOLSequencerVST extends VSTPluginAdapter {
  ...
  public GOLSequencerVST(long wrapper) {
    super(wrapper);
  ...
  public void setup(){
	  ...
	  sequencer = new ControlSequencer(this, 1, 340, 50, true, controlP5);
  }
  ...
  public int canDo(String feature) {
    int ret = GOLSequencerVST.CANDO_NO;

    if (GOLSequencerVST.CANDO_PLUG_RECEIVE_VST_EVENTS.equals(feature)) ret = GOLSequencerVST.CANDO_YES;
    if (GOLSequencerVST.CANDO_PLUG_RECEIVE_VST_MIDI_EVENT.equals(feature)) ret = GOLSequencerVST.CANDO_YES;
    if (GOLSequencerVST.CANDO_PLUG_MIDI_PROGRAM_NAMES.equals(feature)) ret = GOLSequencerVST.CANDO_YES;
